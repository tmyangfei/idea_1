...
<script type="text/javascript">
	function query() {
		//执行关键词查询时清空过滤条件
		document.getElementById("catelog_name").value="";
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<form id="actionForm" action="/item/list" method="POST">
					...
					<input type="hidden" name="catelog_name" id="catelog_name" value="${catelog_name }"/>
			...
			<div class="attr">
				...
				<div class="a-values">
					<div class="v-tabs">
						<div class="tabcon">
							<div>
								<a href="javascript:filter('catelog_name', '幽默杂货')" >幽默杂货</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '时尚卫浴')">时尚卫浴</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '另类文体')">另类文体</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '创意相架')">创意相架</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '巧妙收纳')">巧妙收纳</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '与钟不同')">与钟不同</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '个性男人')">个性男人</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '电脑周边')">电脑周边</a>
							</div>
							<div>
								<a href="javascript:filter('catelog_name', '品质家电')">品质家电</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '品味茶杯')">品味茶杯</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '四季用品')">四季用品</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '健康宝宝')">健康宝宝</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '新潮美容')">新潮美容</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '产品配件')">产品配件</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '雅致灯饰')">雅致灯饰</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '阳光车饰')">阳光车饰</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '趣味纸抽')">趣味纸抽</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '布艺毛绒')">布艺毛绒</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '益智手工')">益智手工</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '环保餐具')">环保餐具</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '闪亮匙扣')">闪亮匙扣</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '手机饰品')">手机饰品</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '精品数码')">精品数码</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '理财钱罐')">理财钱罐</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '美味厨房')">美味厨房</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '保健按摩')">保健按摩</a>
							</div>						                      
							<div>						                      
								<a href="javascript:filter('catelog_name', '魅力女人')">魅力女人</a>
							</div>
						</div>
					</div>
				</div>
